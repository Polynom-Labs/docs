...
The Audit UI is a React and Vite application. It does not execute end-user private transfers. It consumes authenticated backend APIs for organization management, application workspaces, disclosure cases, reports, and activity logs.

## Workspace routes

| Workspace | Routes | Backing scope |
| --- | --- | --- |
| Organization owner | `/workspace/organization-owner/overview`, `/applications`, `/team`, `/activity` | `auth/me.owner` permissions |
...
| `/workspace/application/:foreignId/reports` | Application case report list |
