...
<CardGroup cols={2}>
  <Card title="Operations — Transfer" icon="arrow-right-arrow-left" href="/products/privacy-layer/sdk/concepts/operations#transfer-to-registered-recipient">
    Registered recipient transfer semantics.
  </Card>
  <Card title="Domain model" icon="sitemap" href="/products/privacy-layer/sdk/concepts/domain-model#private-address-registry">
