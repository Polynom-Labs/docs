...
<Columns cols={2}>
  ...
  <Card
    title="Stellar operation lifecycle"
    icon="star"
    href="/products/privacy-layer/sdk/concepts/operation-lifecycle"
  >
    Prepare and execute errors, retry, and persisted SDK state.
  </Card>
  ...
  >
    Solana application example. A network runbook is not published yet.
  </Card>
