...
| One application is affected | Application assignment, status, and contract association | **Application administrator** |
...
`No active membership for the selected organization` means that WorkOS does
not report an active membership for the current user and organization.
